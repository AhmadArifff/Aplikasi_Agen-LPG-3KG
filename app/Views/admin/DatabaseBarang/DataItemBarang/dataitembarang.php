                        ...
                        <table id="myTable" class="table table-striped table-bordered">
                            <thead>
                                <tr class="table-primary">
                                    ...
                                    <th>Jumlah Item Barang Stock (qty)</th>
                                    <th>Jumlah Item Barang Stock Sudah Terjual (qty)</th>
                                    <th>Jumlah Item Barang Sudah DIbeli (qty)</th>
                                    <th>Jumlah Item Barang Belum Dibeli (qty)</th>
                            ...
                            <tbody>
                                ...
                                foreach ($tb_item_barang as $item_barang) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?= $item_barang['ib_qty_stok'] ?></td>
