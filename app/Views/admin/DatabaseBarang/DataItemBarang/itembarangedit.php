                        ...
                        <form method="post" action="" id="text-editor" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" name="ib_qty_stok" class="form-control hargaasli" placeholder="Masukan Jumlah Item Barang Stock (qty)" value="<?= $tb_item_barang['ib_qty_stok'] ?>" required>
                                </div>
                                <div class="form-group col-6">
                                    <label for="">Jumlah Item Barang Yang Akan Dibeli (QTY)</label>
                                    <input id="" type="text" class="form-control hargajual" name="ib_qty_beli" placeholder="Masukan Jumlah Item Barang Yang Akan Dibeli (QTY)" value="<?= $tb_item_barang['ib_qty_beli'] ?>" required>
                                </div>
