...
<li class="nav-item <?= ($RegisterUser == 'registeruser') || ($RegisterSupplier == 'registersupplier') ? 'active' : '' ?>">
    <a class="nav-link" href="<?= base_url(); ?>/admin/formsregister/datauser"><i class="far fa-user "></i> <span>Database Users</span></a>
</li>
